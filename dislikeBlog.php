...
$sql_dislike="UPDATE blogs SET dislike_count=dislike_count+1 WHERE blog_id=".$blog_id.";";
$res_dislike=mysqli_query($mysqli, $sql_dislike);

if($res_dislike){
    $_SESSION["dislike".$blog_id.""]="dislike".$blog_id."";
